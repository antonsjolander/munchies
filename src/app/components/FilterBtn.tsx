...
export function FilterBtn({
	...
	const classNames = {
		button: `hover:bg-green text-black border border-stroke hover:text-white text-body py-2 px-3 rounded-lg ${
			active ? "bg-green text-white" : ""
		}`,
		card: `hover:bg-green hover:text-white group w-[160px] h-[80px] p-3 border-stroke border overflow-hidden flex-shrink-0 rounded-[8px] ${
